import { Text, URL, Organization, Person, GeoShape, QuantitativeValue } from "schema-dts";
...
export interface Offer {
    ...
    acceptedPaymentMethod?: SchemaValue<LigoPaymentMethod, "acceptedPaymentMethod">;
